...
<body>
<div class="box">
<div style="display: flex; align-items: center; background-image: url('images/banner_blue.png'); background-size: 100% 100%; height: 100px; height: 130px;">


    <div style="text-align: center; flex-grow: 1; padding: 20px;">
        <h1 style="font-size: 45px; font-weight: 900; color: white; padding: 30px 0px 10px 0px; margin: 0;">ALABANG STATION</h1>
    </div>
</div>
<br>
...
<table id="example" class="table">
        ...
        <tbody id="dynamicTableBody">
        <?php displayScheduleTutuban("tutuban"); ?>
</tbody>
    </table>
</div>
</div>
