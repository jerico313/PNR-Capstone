...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insert data into the "comments_complaints" table
    $insertQuery = "INSERT INTO comments_complaints (name, email, subject, message) VALUES ('$name', '$email', '$subject', '$message')";
    if (mysqli_query($conn, $insertQuery)) {
        echo "Comments and Complaints submitted successfully!";
        // Add JavaScript alert after successful submission
        echo '<script>alert("Comments and Complaints submitted successfully!"); window.location.href = "comments_complaints.php";</script>';
    } else {
...
<div style="display: flex; align-items: center; background-image: url('images/banner_blue.png'); background-size: 100% 100%; height: 130px; ">
    <div style="text-align: center; flex-grow: 1; padding: 20px;">
        <h1 style="font-size: 45px; font-weight: 900; color: white; padding: 30px 0px 10px 0px; margin: 0;">COMMENTS AND COMPLAINTS</h1>
    </div>
</div>
</div>
...
<div class="contact-form">
    ...
    <form action="comments_complaints.php" method="post">
