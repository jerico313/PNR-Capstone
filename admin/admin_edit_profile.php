                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="profile-info">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="first-name" name="adm_firstName" value="<?php echo $firstname; ?>" style= "width: 300px;">
                                </div><br>
                                <div class="form-group">
                                    <label for="last-name">Last Name</label>
                                    <input type="text" class="form-control" id="last-name" name="adm_lastName" value="<?php echo $lastname; ?>" style="width: 300px;"> <!-- Adjusted width -->
                                </div>
                            </div>
...
<script>
    ...
    function updateProfile() {
        ...
        data.append('adm_firstName', firstName);
        data.append('adm_lastName', lastName);
