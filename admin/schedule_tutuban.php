...
<div class="modal fade" id="confirmResetTrainModal" tabindex="-1" aria-labelledby="deleteModalTutubanLabel" aria-hidden="true">
   ...
   <div class="content ">
      ...
      <div class="row">
            ...
            <li class="nav-item">
               <a class="nav-link active" data-bs-toggle="tab" href="#TutubantoAlabang" style="color: #FFC30B;font-weight:900;">Tutuban to Alabang</a>
            </li>
            <li class="nav-item">
               <a class="nav-link" data-bs-toggle="tab" href="#AlabangtoTutuban" style="color:#FFC30B;font-weight:900;">Alabang to Tutuban</a>
            </li>
         </ul>
...
function downloadTables() {
    ...
    link.setAttribute("download", `schedule_tutuban_alabang_${formattedDate}.csv`);
