   ...
   <div class="content ">
      ...
      <div class="row">
         ...
         <div class="tab-content">
            ...
            <select style="width: 243px; display: inline-block; margin-left: auto; margin-right: 11px; margin-top: 0" class="form-select" id="updateTrainEDSA" name="updateTrainEDSA" required onchange="updateTrainEDSA()">
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
         <div class="modal-dialog">
            ...
            <div class="train" style="padding-top:20px;display:block;padding-left:30px;">
            <select style="width: 243px; display: inline-block; margin-left: auto; margin-right: 11px; margin-top: 0" class="form-select" id="updateTrainTutubanEDSA" name="updateTrainTutubanEDSA" required onchange="updateTrainTutubanEDSA()">
            <option value="" disabled selected>Select Train</option>
                <?php
                foreach ($trains as $train) {
                    echo '<option value="' . $train['train_value'] . '" data-station-id="' . $train['train_no'] . '">' . $train['train_no'] . '</option>';
...
<script>
    function updateTrainEDSA() {
        var selectedTrain = document.getElementById("updateTrainEDSA").value;
...
<script>
    function updateTrainTutubanEDSA() {
        var selectedTrain = document.getElementById("updateTrainTutubanEDSA").value;
        ...
        if (selectedTrain !== "" && selectedSchedules.length > 0) {
            $.ajax({
                type: 'POST',
                url: 'update_train_tutuban_edsa.php',
                data: { train: selectedTrain, selectedSchedules: selectedSchedules },
                success: function (response) {
                    location.reload();
                },
