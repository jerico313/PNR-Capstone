                    ...
                    <div class="container-fluid">
                        ...
                        <br>
                            <div class="col-lg-4">
                                ...
                                <a href="reg_passenger.php" style="color:#174793;font-size:15px;text-decoration:none;">View More <i class="fa-solid fa-arrow-right"></i></a>   
                            </div>
                            </div>
                            <div class="col-lg-4">
                                ...
                                <a href="reg_employee.php" style="color:#174793;padding:0 0 0 0;font-size:15px;text-decoration:none;">View More <i class="fa-solid fa-arrow-right"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                    ...
                                    <a href="trains.php" style="color:#174793;padding:0 0 0 0;font-size:15px;text-decoration:none;">View More <i class="fa-solid fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
