...
// Check if the user is logged in (check for admin_id in the session)
...
$firstname = $_SESSION['adm_firstname'];
$lastname = $_SESSION['adm_lastname'];
...
<div class="container">
    <div class="row">
        <div class="col-md-6 col-sm-12">
            <div class="edit-user">
                <div class="logo">
                <p style="position: absolute; top: 10px; left: 78px; transform: translateX(-50%); color: white; font-size: 15px; font-weight: 900;">Change Password</p>
                </div>
<br><br>
