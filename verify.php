...
<nav class="navbar navbar-expand-md navbar-light fixed-top mainnav">
  <div class="container-fluid">
    ...
    <div class="verification-container">
        <center>
        <img src="images/verification.png" width="80" height="80">
        </center>
        <h3>Authentication</h3>
        <p>Enter the verification code sent to your email address.</p>
        <form action="email_verif.php" method="post">
            <div class="form-group">
                <label for="verification_code">Verification Code:</label>
                <input type="text" name="verification_code" required>
            </div>
            <button type="submit" name="verify" class="btn-submit" style="width:100%;">Verify</button>
        </form>
    </div>
</body>
</html>
